...
describe("regression: manager photo capture flow", () => {
  it("shows photo actions for players and staff with smartphone guidance", () => {
    ...
    expect(source).toContain("md:grid-cols-[32px_96px_minmax(0,1fr)]");
    expect(source).toContain("xl:grid-cols-[32px_96px_minmax(240px,1fr)_minmax(220px,340px)_minmax(220px,340px)]");
