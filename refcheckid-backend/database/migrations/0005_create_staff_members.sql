CREATE TABLE staff_members (
    ...
    CONSTRAINT uq_staff_members_federation_fiscal_code UNIQUE (federation_id, fiscal_code),
...
CREATE INDEX idx_staff_members_federation_id ON staff_members (federation_id);
