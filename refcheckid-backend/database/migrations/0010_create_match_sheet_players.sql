CREATE TABLE match_sheet_players (
    ...
    CONSTRAINT uq_match_sheet_players_sheet_registration UNIQUE (match_sheet_id, player_registration_id),
    CONSTRAINT uq_match_sheet_players_sheet_shirt UNIQUE (match_sheet_id, shirt_number),
...
CREATE INDEX idx_match_sheet_players_match_sheet_id ON match_sheet_players (match_sheet_id);
CREATE INDEX idx_match_sheet_players_player_registration_id ON match_sheet_players (player_registration_id);
CREATE INDEX idx_match_sheet_players_status ON match_sheet_players (status);
